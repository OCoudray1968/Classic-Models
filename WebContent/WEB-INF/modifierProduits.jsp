		...
		<header>
			<div id="titre_principal">
				...
				<div id="logo">
					...
					<h1>Classic Models : Modification produit</h1>
					<br>
...
<div id="corps">
	<c:choose>
		...
		<c:otherwise>
		<form method="post" action="<c:url value="/updateProductServlet" />">
			Code Produit :<Select name="codeproduit" >
				...
				<c:forEach items="${ sessionScope.produits }" var="produits"
					varStatus="boucle">
				 	...
				 	<%-- Affichage des listes deroulantes Numéro Client, et Nom Client --%>
						<option value="${ produits.productCode }">${produits.productCode} ${produits.productName }</option>
