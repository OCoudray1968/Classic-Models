...
<div id="banniere_menu">
		<p>
			<a href="<c:url value="/listEmployeesServlet"/>">Voir les employés existants</a>
		</p>
		<p>
			<a href="<c:url value="/createEmployeeServlet"/>">Créer un nouvel employé</a>
		</p>
		<p>
			<a href="<c:url value="/updateEmployeeServlet"/>">Modifier un employé existant</a>
		</p>
		<p>
			<a href="<c:url value="/deleteEmployeeServlet"/>">Supprimer un employé existant</a>
		</p>
