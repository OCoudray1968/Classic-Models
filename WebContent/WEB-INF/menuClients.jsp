...
<div id="banniere_menu">
		<p>
			<a href="<c:url value="/listCustomersServlet"/>">Voir les clients existants</a>
		</p>
		<p>
			<a href="<c:url value="/createCustomerServlet"/>">Créer un nouveau client</a>
		</p>
		<p>
			<a href="<c:url value="/updateCustomersServlet"/>">Modifier un client existant</a>
		</p>
		<p>
			<a href="<c:url value="/deleteCustomersServlet"/>">Supprimer un client existant</a>
		</p>
