...
public class OrderDetailsDAO extends AbstractDAO {
	...
	public String generateWHEREquery(AbstractDTO odb) {
		...
		sb.append(" WHERE orderNumber LIKE ").append(bean.getOrderNumber());
		sb.append(" AND ");
		sb.append("orderLineNumber LIKE '").append(bean.getOrderLineNumber()).append("'");

		return sb.toString();
	}

	/*
	 * Génère la seconde partie d'une requ�te INSERT* VALUES ( 'valeur 1', 'valeur
	 * 2', ... )
	 * 
...
// Clause WHERE
		sb.append("WHERE orderNumber = '").append(bean.getOrderNumber()).append("' AND ").append(" orderLineNumber ='")
	...
	public String generateDeletequery(AbstractDTO ab) {
		OrderDetailsDTO bean = (OrderDetailsDTO) ab;
		StringBuilder sb = new StringBuilder();
