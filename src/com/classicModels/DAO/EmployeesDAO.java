...
public  String generateWHEREquery(AbstractDTO eb) {
	...
	if (bean.getEmployeeNumber() != 0) {
		isWhereClause = true;
		sb.append(" WHERE EmployeeNumber = ")
		  .append(bean.getEmployeeNumber());
	}
	...
	if (bean.getLastName() != null && !bean.getLastName().isEmpty()) {
		...
		sb.append("LastName LIKE '")
		  .append(bean.getLastName()).append("'");
	}
	...
	if (bean.getFirstName() != null && !bean.getFirstName().isEmpty()) {
		...
		sb.append("FirstName LIKE '")
		  .append(bean.getFirstName()).append("'");
	}
	...
	if (bean.getExtension() != null && !bean.getExtension().isEmpty()) {
		...
		sb.append("extension LIKE '")
		  .append(bean.getExtension()).append("'");
	}
	...
	if (bean.getOfficeCode() != 0) {
		...
		sb.append("OfficeCode LIKE '")
		  .append(bean.getOfficeCode()).append("'");
	}
	...
	if (bean.getReportsTo() != 0) {
		...
		sb.append("reportsTo LIKE '")
		  .append(bean.getReportsTo()).append("'");
	}
	...
	if (bean.getJobTitle()!= null && !bean.getJobTitle().isEmpty()) {
		...
		sb.append("jobTitle LIKE '")
		  .append(bean.getJobTitle()).append("'");
	}
...
/*
 * Génère la deuxième partie de la requete Insert
 * VALUES (
 *   'valeur 1', 'valeur 2', ...
 * )
 * 
