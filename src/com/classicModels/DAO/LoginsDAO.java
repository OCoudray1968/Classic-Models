...
public class LoginsDAO extends AbstractDAO {
	...
	public String generateWHEREquery(AbstractDTO cb) {
		...
		if (bean.getClass() != null) {
		  if (bean.getLogin()!=null) {
			...
			sb.append(" WHERE login LIKE ")
			.append("'").append(bean.getLogin()).append("'")
			   .append(" AND pwd LIKE ")
			   .append("'").append(bean.getPasswordLogin()).append("'")
			  	.append(";");
		   }
		  }
	...
	public String generateUPDATEquery(AbstractDTO ab) {
		...
		// Le login
				...
				sb.append("OR EmployeeNumber LIKE").append(bean.getEmployeeNumber());
