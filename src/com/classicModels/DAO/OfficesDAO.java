...
public String generateWHEREquery(AbstractDTO ob) {
	...
	if (bean.getOfficeCode() != 0) {
		isWhereClause = true;
		sb.append(" WHERE officeCode LIKE ")
		  .append(bean.getOfficeCode());
	}
	...
	if (bean.getPhoneOffice() != null && !bean.getPhoneOffice().isEmpty()) {
		...
		sb.append("phone LIKE '")
		  .append(bean.getPhoneOffice()).append("'");
	}
	...
	if (bean.getStateOffice() != null && !bean.getStateOffice().isEmpty()) {
		...
		sb.append("state LIKE '")
		  .append(bean.getStateOffice()).append("'");
	}
	...
	if (bean.getCountryOffice() != null && !bean.getCountryOffice().isEmpty()) {
		...
		sb.append("country LIKE '")
		  .append(bean.getCountryOffice()).append("'");
	}
	...
	if (bean.getTerritory() != null && !bean.getTerritory().isEmpty()) {
		...
		sb.append("territory LIKE '")
		  .append(bean.getTerritory()).append("'");
	}
