...
public class RegistrationDTO extends AbstractDTO {
	...
	public String toString() {
		...
		sb.append("[RegistrationDTO]\n").append("customerNumber : ").append(this.getCustomerNumber()).append(",\n")
				...
				.append(this.getAddressLine1()).append(", \n").append("addressLine2 : ").append(this.getAddressLine2())
				...
				.append(this.getContactLastName()).append(", \n").append("FirstName : \n")
				.append(this.getContactFirstName()).append(",").append("Email : ").append(this.getEmail())
				.append(", \n ").append("login :").append(this.getLogin()).append(",").append("password :")
				.append(this.getPwd()).append(";\n");
