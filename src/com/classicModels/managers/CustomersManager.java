...
public class CustomersManager {
    /*
     * Met à jour un enregistrement dans la table <code>classicmodels.Customers</code>.<br/>
     * Appel de <code>CustomersDAO.update(dto.getBean())</code>.
     */
	...
	public static AbstractDTO delRecord(AbstractDTO bean) {
		CustomersDAO client = new CustomersDAO(); 
		List <AbstractDTO>l = client.delete(bean);
		return l.get(0);
	}
	/**
